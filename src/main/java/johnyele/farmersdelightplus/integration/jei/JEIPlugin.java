...
public class JEIPlugin implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		if (ModCommonConfig.ENABLE_FROGSPAWN_BOWL_PICKING_UP.get())
			registration.addIngredientInfo(new ItemStack(Items.FROGSPAWN), VanillaTypes.ITEM_STACK, Component.translatable(FarmersdelightplusMod.MODID + ".jei.info.frogspawn"));
	}
